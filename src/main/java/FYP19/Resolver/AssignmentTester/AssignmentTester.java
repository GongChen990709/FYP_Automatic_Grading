package FYP19.Resolver.AssignmentTester;


import FYP19.Resolver.JSONConverter.JSONClassConverter;
import FYP19.Resolver.MethodTester.MethodTester;
...
public class AssignmentTester {
    ...
    private Map<String, List<Class<?>>> testDataType;
    private String constructorName;
    private List<String> testMethodName;


    public AssignmentTester(String dataType){
    ...
    public Map<String, List<Class<?>>> getTestDataType(){
