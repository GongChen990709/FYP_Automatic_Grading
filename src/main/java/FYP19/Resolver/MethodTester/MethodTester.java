package FYP19.Resolver.MethodTester;



import FYP19.Resolver.ReflectionImp.ReflectionCaller;
...
public class MethodTester {
    ...
    private Map<String, List<Class<?>>> testMethodWithParametersType;


    //No-parameter instantiation for the specified testClass
    public MethodTester(String classPath, String className, String constructorName, Map<String,List<List<Object>>> testMethodWithTestData, Map<String, List<Class<?>>> testMethodWithParametersType) throws ReflectionCallerErrorException {
        this.testMethodWithTestData = testMethodWithTestData;
        this.testMethodWithParametersType = testMethodWithParametersType;
        this.testClass = new ReflectionCaller(classPath, className, this.testMethodWithParametersType.get(constructorName), this.testMethodWithTestData.get(constructorName).get(0).toArray());
    }
