...
public class MailService {
    ...
    public boolean sendEmailToStudent(Students stu, String activation_code) {
        String controllerPath = "http://localhost:8080/autoGrading/register/doStudentActivation";
        String content = "<html>"+
                "<body>"+
                "Hello "+ stu.getName() + ". Please click the link below to activate your account<br>" +
    ...
    public boolean sendEmailToTeacher(Teacher teacher, String activation_code) {
        String controllerPath = "http://localhost:8080/autoGrading/register/doTeacherActivation";
        String content = "<html>"+
                "<body>"+
                "Hello "+ teacher.getName() + ". Please click the link below to activate your account<br>" +
